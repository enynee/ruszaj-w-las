...
export default function() {
    ...
    return <Layout>
        ...
        { zdobyta === true && <div className="opis-punktu">
            <p className="p-opis">Jesteś w wyjątkowym miejscu w pobliżu jeziora Wygoda, Pałsznik i Krypko oraz przy rezerwacie przyrody Pełcznica. Głaz przy którym stoisz to pomnik przyrody. Rezerwat z jeziorami jak i otaczający je drzewostan tworzy obszar ochrony siedlisk Natura 2000 Pełcznica.</p> 
